...
<main class="produtoDetalhe">
  ...
  <div class="infoProduto">
    ...
    <h2 id="precoProduto"></h2>



    <button id="adicionarCarrinho">
      Adicionar ao carrinho
    </button>

    <button id="botaoFavorito" type="button">
...
<script src="assets/scripts/produto.js"></script>
