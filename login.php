...
<head>
    ...
    <title>Login - Remédios da Vovó</title>
...
<main class="page">
    ...
    <section class="form-card login-card">
        ...
        <div class="form-title">
            ...
            <div class="title-icon login-icon">
        ...
        <form id="formLogin">
            ...
            <div class="field full">
                ...
                <div class="input-box">
                    ...
                    <i
                            class="fa-regular fa-eye password-eye"
                            onclick="mostrarSenha('loginSenha', this)">
                    </i>
